...
class BranchGenerator:
    ...
    def _build_record(self, seq: int) -> dict:
        ...
        opened = date.today() - timedelta(days=random.randint(180, 365 * 20))
        return {
    ...
    def generate(self, count: int) -> List[int]:
        ...
        with self.conn.cursor() as cur:
            ...
            for i in range(count):
                batch.append(self._build_record(i + 1))
