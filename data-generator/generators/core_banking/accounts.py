...
class AccountGenerator:
    ...
    def _build_record(
        ...
        # opened_date: tersebar merata dalam range (akun dibuka dalam periode ini)
        opened = _rand_date_in_range(range_start, range_end)
        ...
        return {
            ...
            "opened_date": opened,
            "closed_date": range_end - timedelta(days=random.randint(0, max((range_end - opened).days, 0))) if status == "closed" else None,
            "created_at": datetime(
        ...
        try:
            psycopg2.extras.execute_batch(
                ...
                INSERT INTO accounts (
                    ...
                    %(opened_date)s, %(closed_date)s, %(created_at)s, %(created_at)s
                )
